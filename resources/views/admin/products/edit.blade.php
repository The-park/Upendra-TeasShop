            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-8">
                            ...
                            @if($product->cost_price)
                                <div class="alert alert-info">
                                    <h6>Current Profit Analysis:</h6>
                                    <p class="mb-0">
                                        <strong>Profit Amount:</strong> ${{ $product->profit_amount }}<br>
                                        <strong>Profit Margin:</strong> {{ $product->profit_percentage }}%
                                    </p>
                                </div>
                            @endif
                        ...
                        <div class="col-md-4">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div id="image-upload-area">
                                            ...
                                            <p class="text-muted mb-3">
                                                {{ $product->image ? 'Upload new image' : 'Click to select an image' }}
                                            </p>
                            ...
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <p class="mb-1"><strong>Created:</strong> {{ $product->created_at->format('M j, Y') }}</p>
                                    <p class="mb-1"><strong>Last Updated:</strong> {{ $product->updated_at->format('M j, Y g:i A') }}</p>
                    ...
                    <div class="form-group mt-4">
                        ...
                        <a href="{{ route('admin.products.show', $product) }}" class="btn btn-info ml-2">
